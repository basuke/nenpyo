...
<svelte:head><title>nenpyo.net</title></svelte:head>

<h1 class="page__title">関心年表</h1>
<p class="page__lead">つくりかけの叩き台です。</p>
...
{#if data.user}
  <p style="margin-top: 2rem"><a href="/@{data.user.username}/-/new">新しい年表をつくる</a></p>
{/if}
